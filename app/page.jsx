      ...
      <section className="mt-20 pb-12 space-y-10 md:space-y-15 px-5">
        <div className="container mx-auto px-4 md:px-6 text-center space-y-6">
          <Badge variant="outline" className="bg-green-100 text-green-700">
            AI-Powered Finances. Zero Awkwardness. ✨
          </Badge>
          <h1 className="gradient-title mx-auto max-w-6xl text-4xl font-bold md:text-8xl">
            The smartest way to share bills and crush your budget.
          </h1>

          <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl/relaxed">
            Let our AI manage the math, the monthly reviews, and the friend
            reminders. We turn shared expenses into simple settlements so you
            can focus on the next adventure.
          </p>
